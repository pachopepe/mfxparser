...
-- I included  calculational expressions for quantifiers, containers and substitution
...
--
-- I added backtracking by expresion length to solve ambiguities;
...
-- 
-- I developed this parser to construct a calculational style prover assistant.
--
